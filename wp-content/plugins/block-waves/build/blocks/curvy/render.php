<?php
	...
	$invertPath = "M985.66,92.83C906.67,72,823.78,31,743.84,14.19c-82.26-17.34-168.06-16.33-250.45.39-57.84,11.73-114,31.07-172,41.86A600.21,600.21,0,0,1,0,27.35V120H1200V95.8C1132.19,118.92,1055.71,111.31,985.66,92.83Z";
...
<div <?php echo $block_wrapper_attributes; ?> >
	...
	<div class="curve top-curve" style="display: <?php echo $attributes['enableTopCurve'] ? 'block' : 'none'; ?>;transform: <?php echo $topTransform; ?>;height: <?php echo $attributes['topHeight']; ?>px">
		<svg style="height: <?php echo $attributes['topHeight']; ?>px; width: <?php echo $attributes['topWidth'] ;?>%" preserveAspectRatio="none" viewBox="0 0 1200 120" >
			<path fill="<?php echo $attributes['topColor'] ?? 'white'; ?>" d="<?php echo $attributes['topFlipY'] ? $invertPath: $normalPath; ?>"/>
		</svg>
	</div>
	...
	<div class="curve bottom-curve" style="display: <?php echo $attributes['enableBottomCurve'] ? 'block' : 'none'; ?>;transform: <?php echo $bottomTransform; ?>;height: <?php echo $attributes['bottomHeight']; ?>px">
		<svg style="height: <?php echo $attributes['bottomHeight']; ?>px; width: <?php echo $attributes['bottomWidth'] ;?>%" preserveAspectRatio="none" viewBox="0 0 1200 120" >
			<path fill="<?php echo $attributes['bottomColor'] ?? 'white'; ?>" d="<?php echo $attributes['bottomFlipY'] ? $invertPath: $normalPath; ?>"/>
		</svg>
	</div>
</div>
